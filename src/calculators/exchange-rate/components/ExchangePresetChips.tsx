...
export const ExchangePresetChips: React.FC<ExchangePresetChipsProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-ghost-dark-surface rounded-[24px] border border-[#e5e7eb] dark:border-ghost-dark-hairline p-4 sm:p-5 space-y-2.5 shadow-2xs transition-colors">

            ...
            >
              <div className='flex items-center justify-between gap-1'>
                <div className='min-w-0'>
                  ...
                  <span className='text-sm sm:text-base font-bold text-[#112220] dark:text-slate-100 tabular-nums'>
              ...
              <div className='space-y-0.5 pt-1 border-t border-slate-100 dark:border-slate-800'>
                ...
                <p className='text-base sm:text-lg font-extrabold text-[#112220] dark:text-slate-100 tabular-nums break-keep'>
              ...
              <div className='pt-1.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-[11px] gap-1'>
                <span className='text-slate-400 shrink-0'>총 투입 원금</span>
                <span className='font-semibold text-slate-600 dark:text-slate-300 tabular-nums truncate'>
